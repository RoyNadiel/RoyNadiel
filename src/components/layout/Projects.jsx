  ...
  const Projects = [
    {
      id:1,
      name: "WrittingJS",
      src: "./projects/ShowCodeWrittingJS.mp4",
>>>>>>> 068a6b2 (feat: se añadió el CV a proyectos. Styles: se actualizó el mp4 del WrittingJS.)
      description: "Playground de JavaScript similar a RunJS. Menos permisivo, diseñado para preservar buenas practicas.",
...
=======
    ...
    },
    {
      ...
      name: "CV",
      src: "./projects/CV.mp4",
      description: "Versión PDF de mi hoja de vida como programador.",
      skills: ["React", "Vite SSR", "TypeScript", "Hono", "Cloudflare Workers"],
      skillUsed: "TS",
      imageWidth: "80",
      projectUrl: "https://github.com/RoyNadiel/CV"
    }
  ]
