...
export default function Card( {name, image, description, skills, skillUsed, imageWidth, projectUrl, onMouseEnter, onMouseLeave }) {
    return(
        <article className="relative w-fit h-fit scaleSmoothly">
            ...
            md:w-100">
                <div className='w-fit h-fit border-2 rounded-lg border-indigo-500 p-0.5'>
                    <img src={image} alt={name} className={`max-w-${imageWidth} object-cover`}/>
                </div>
